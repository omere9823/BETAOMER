...
//    public void set_array(Ingrediant arr[]){
//        this._array = arr;
//    }
    ...
    public Ingrediant[] get_ingrediats(){
        return this._array;
    }

    public Ingrediant[] get_array(){
        return this._array;
    }
    ...
    public void setNewAmount(String name, Ingrediant.status st){
